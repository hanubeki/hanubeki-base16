# tinted-shell (tinted8) hanubeki-shidare-light for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:TINTED8_THEME = "hanubeki-shidare-light"
...
Write-Host -NoNewline "`e]4;4;rgb:51/69/a6`e\"
...
Write-Host -NoNewline "`e]4;12;rgb:6a/82/c1`e\"
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_TINTED8_VARS")) {
    ...
    $Env:TINTED8_COLOR_BLUE_NORMAL_HEX = "5169a6"
    ...
    $Env:TINTED8_COLOR_BLUE_BRIGHT_HEX = "6a82c1"
    ...
    $Env:TINTED8_COLOR_BLUE_DIM_HEX = "37508c"
