# tinted-shell (tinted8) hanubeki-kokuban-light for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:TINTED8_THEME = "hanubeki-kokuban-light"
...
Write-Host -NoNewline "`e]4;3;rgb:ad/8d/31`e\"
...
Write-Host -NoNewline "`e]4;11;rgb:ca/a7/49`e\"
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_TINTED8_VARS")) {
    ...
    $Env:TINTED8_COLOR_YELLOW_NORMAL_HEX = "ad8d31"
    ...
    $Env:TINTED8_COLOR_YELLOW_BRIGHT_HEX = "caa749"
    ...
    $Env:TINTED8_COLOR_YELLOW_DIM_HEX = "917317"
    $Env:TINTED8_COLOR_BLUE_DIM_HEX = "00587e"
    $Env:TINTED8_COLOR_MAGENTA_DIM_HEX = "5a4788"
