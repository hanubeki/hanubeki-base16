# tinted-shell (tinted8) hanubeki-shidare for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:TINTED8_THEME = "hanubeki-shidare"
...
Write-Host -NoNewline "`e]4;4;rgb:6a/82/c1`e\"
...
Write-Host -NoNewline "`e]4;12;rgb:84/9c/dd`e\"
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_TINTED8_VARS")) {
    ...
    $Env:TINTED8_COLOR_BLUE_NORMAL_HEX = "6a82c1"
    ...
    $Env:TINTED8_COLOR_BLUE_BRIGHT_HEX = "849cdd"
    ...
    $Env:TINTED8_COLOR_BLUE_DIM_HEX = "5169a6"
