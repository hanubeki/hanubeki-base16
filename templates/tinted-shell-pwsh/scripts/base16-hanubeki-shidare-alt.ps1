# tinted-shell (base16) hanubeki-shidare-alt for PowerShell
# scheme made by hanubeki

$Env:BASE16_THEME = "hanubeki-shidare-alt"
...
Write-Host -NoNewline "`e]4;16;rgb:ff/a0/8d`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:ac/77/6c`e\" # base0F
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_09_HEX = "ffa08d"
    ...
    $Env:BASE16_COLOR_0F_HEX = "ac776c"
}
