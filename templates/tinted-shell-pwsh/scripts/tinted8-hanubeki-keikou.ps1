# tinted-shell (tinted8) hanubeki-keikou for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:TINTED8_THEME = "hanubeki-keikou"
...
Write-Host -NoNewline "`e]4;8;rgb:34/3c/47`e\"
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_TINTED8_VARS")) {
    ...
    $Env:TINTED8_COLOR_BLACK_BRIGHT_HEX = "343c47"
