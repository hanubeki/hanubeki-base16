# tinted-shell (base16) hanubeki-kokuban-light for PowerShell
# scheme made by hanubeki

$Env:BASE16_THEME = "hanubeki-kokuban-light"
...
Write-Host -NoNewline "`e]4;11;rgb:ad/8d/31`e\" # base0A
