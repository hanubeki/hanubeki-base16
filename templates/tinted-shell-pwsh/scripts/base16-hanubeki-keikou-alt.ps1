# tinted-shell (base16) hanubeki-keikou-alt for PowerShell
# scheme made by hanubeki

$Env:BASE16_THEME = "hanubeki-keikou-alt"
...
Write-Host -NoNewline "`e]4;16;rgb:f5/a8/63`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:a6/7b/57`e\" # base0F
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_09_HEX = "f5a863"
    ...
    $Env:BASE16_COLOR_0F_HEX = "a67b57"
}
