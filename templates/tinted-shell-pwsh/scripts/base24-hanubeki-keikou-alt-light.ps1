# tinted-shell (base24) hanubeki-keikou-alt-light for PowerShell
# scheme made by hanubeki

$Env:BASE24_THEME = "hanubeki-keikou-alt-light"
...
Write-Host -NoNewline "`e]4;9;rgb:c1/6c/5b`e\" # base12
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_12_HEX = "c16c5b"
