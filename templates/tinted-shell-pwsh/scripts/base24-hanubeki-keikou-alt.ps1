# tinted-shell (base24) hanubeki-keikou-alt for PowerShell
# scheme made by hanubeki

$Env:BASE24_THEME = "hanubeki-keikou-alt"
...
Write-Host -NoNewline "`e]4;16;rgb:d6/8e/4c`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:8a/62/40`e\" # base0F
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_09_HEX = "d68e4c"
    ...
    $Env:BASE24_COLOR_0F_HEX = "8a6240"
